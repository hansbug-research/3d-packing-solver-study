...
截至本次复核，初始 Important 均已完成代码或文档修正：CFF、Python 运行说明、第三方快照许可证、raw 归档、来源清单、CI 门禁、benchmark 来源锁定、商业/前端原始记录、provenance 校验和 Markdown/链接检查均已归档。下文保留初始证据和建议，避免把历史 finding 静默删除。
